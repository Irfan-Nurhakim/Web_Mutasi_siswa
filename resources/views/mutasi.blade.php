    ...
    <div class="container rounded mt-4 p-4" style="background-color: #495057;">
        <div class="col-12">
            <form class="row g-3">
                ...
                <div class="col-md-6">
                    <label for="kab_kota_sekolah_tujuan" class="form-label">Masukkan No Whatsapp</label>
                    <input type="text" class="form-control" id="Masukkan No Whatsapp">
                </div>
                <div class="col-md-6">
                    <label for="kab_kota_sekolah_tujuan" class="form-label">Masukkan Alamat Email</label>
                    <input type="email" class="form-control" id="Masukkan Alamat Email">
                </div>
                <div class="col-12">
